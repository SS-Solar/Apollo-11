...
class Configuracion:
    ...
    def crear_dataFrame() -> str:
        ...
        """
        eventos: any = Configuracion.analisis_eventos()
    ...
    def eventos() -> any:
        ...
        """
        try:
            df: any = Configuracion.crear_dataFrame()
    ...
    def gestion_desconexiones() -> any:
        ...
        """
        try:
            dtf: any = Configuracion.crear_dataFrame()
    ...
    def dispositivos_inoperables() -> [str, str, float]:
        ...
        """
        try:
            data_total: str = Configuracion.crear_dataFrame()
