...
class Generador(Copia):
    ...
    def generar_archivos() -> None:
        ...
        try:
            ...
            try:
                if mision == "UNKW":
                    nombre_archivo_log: str = os.path.join("Archivos/Logs/UNKW", f"APL-"+ mision +"-"+ Generador.cantidad_de_archivos_en_carpeta("Archivos/Logs/UNKW") +".log")
